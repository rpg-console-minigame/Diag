                    ...
                    <div class="col-md-4 col-sm-6 mb-4">
                        <div class="card h-100 shadow-sm muestra-card">
                            <div class="card-img-overlay">
                                <span class="badge badge-pill badge-primary"><i class="fas fa-star mr-1"></i>{{ $muestra->calidad->nombre }}</span>
                            </div>
                            <img src="/uploads/{{$muestra->img->link}}" class="card-img-top" alt="Imagen de muestra">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fas fa-flask mr-2"></i>{{$muestra->sigla}}</h5>
                                <p class="card-text"><i class="fas fa-file-alt mr-2"></i><strong>Formato:</strong> {{ $muestra->formato->nombre }}</p>
                                <p class="card-text"><i class="fas fa-map-marker-alt mr-2"></i><strong>Sede:</strong> {{ $muestra->sede->nombre }}</p>
                                <p class="card-text"><i class="fas fa-atom mr-2"></i><strong>Tipo:</strong> {{ $muestra->tipo_naturaleza->nombre }}</p>
                            </div>
                            <div class="card-footer bg-transparent border-top-0">
                                <a href="{{ route('muestra', ['id' => $muestra->id]) }}" class="btn medacOscuro btn-block">
                ...
                <form action="{{ route('guardar') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="formato_muestra"><i class="fas fa-file-alt mr-2"></i>Formato de Muestra:</label>
                    ...
                    <button type="submit" class="btn medacOscuro btn-block mt-3">
...
@section('css')
    <style>
        ...
        .btn-primary, .btn-success, .medacOscuro {
            transition: all 0.3s ease;
            border: none;
        }
        .medacOscuro {
